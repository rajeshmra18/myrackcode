package com.example.aravind.navigation;
...
public class AppBaseActivity extends AppCompatActivity implements MenuItem.OnMenuItemClickListener {
    ...
    Menu menu;
    MenuItem navLogout,navSettings,navProfile,navPreOrderList,navOfferList,navOrders,navOffer,navHome;
