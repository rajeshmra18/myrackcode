...
import com.mairak.bgi.cart.Cart;
import com.mairak.bgi.navigation.AppBaseActivity;
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        progressDialog.dismiss();
                     System.out.println("sdfagggggg"+error);
    ...
    public class ProductListAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (language.equals("a")){
              ...
              System.out.println("Product====" + settings.get(position).optString("product_name"));
            ...
            System.out.println("Array ==== " + imagefield);
             ...
             System.out.println("Image===========" + imagefield  + " nnn " + urll);
                ...
                Picasso.with(DashBoard.this).load(urll).into(canico);
