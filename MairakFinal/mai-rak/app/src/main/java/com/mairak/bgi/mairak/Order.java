...
public class Order extends AppCompatActivity {
    ...
    private String startDate ="",endDate ="",totalUnread;
   ...
   /* private void showDetail(final String product_id) {
    ...
    private void showDetail(final ArrayList<JSONObject> arrayList2, String order_id) {
        ...
        TextView tvreoderButton = dialog.findViewById(R.id.tvreoderButton);
        TextView tvOrdersHead = dialog.findViewById(R.id.tvOrdersHead);

      //  System.out.println( "Arraaayyyy4444" + arrayList2);

        tvreoderButton.setTypeface(Montserrat_Medium);
        tvOrdersHead.setTypeface(Montserrat_Medium);


        if (language.equals("a")){
            tvreoderButton.setText("إعادة ترتيب");
            tvOrdersHead.setText("أوامر");
        }
        ...
        tvreoderButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getreorder(nOID);
            }
    ...
    private void filterAlert() {
        ...
        if (language.equals("a")){
            tvToday.setText("اليوم");
            tvThisMonth.setText("هذا الشهر");
            tvLastMonth.setText("أخر الشهر");
            tvAllOrders.setText("جميع الطلبات");
        }
