...
import com.bgi.mairak.cart.Cart;
import com.bgi.mairak.navigation.AppBaseActivity;
    ...
    public class ProductListAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
           ...
           //  System.out.println("Image===========" + imagefield  + " nnn " + urll);
                ...
                Picasso.with(DashBoard.this).load(urll).placeholder(R.drawable.logo_main).into(canico);
